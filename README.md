...
# 上海交通大学硕士研究生学位论文中期检查报告

# SJTU Master Midterm Examination Report
...
📖 [查看完整文档](#-使用指南) | 🎯 [快速开始](#-快速开始) | 💬 [问题反馈](https://github.com/zh1-z/SJTU-Master-Midterm-Typst-Template/issues)

---

### ✨ 如果这个模板对你有帮助，请[点个 Star ⭐](https://github.com/zh1-z/SJTU-Master-Midterm-Typst-Template) 支持一下！
...
```bash
git clone https://github.com/zh1-z/SJTU-Master-Midterm-Typst-Template.git
cd SJTU-Master-Midterm-Typst-Template/0.1.0
```
...
#show: body => project(
  ...
  name:           "你的名字",
  degree-program: "p",                    // a/p (见说明)
  study-mode:     "f",                    // f/p (见说明)
  supervisor:     "你的导师",
  major:          "你的专业",
  school:         "你的学院",
  ...
  // --- 正文开头的特制表格 ---
  thesis-title: "你的论文题目",           // 支持使用 \n 手动换行
  source-of-research-project: (1, 3),     // 研究课题来源（可多选）
  thesis-proposal-date: "2026-01-01",     // 开题报告日期
...
A: 本模板严格按照官方最新版制作，但如发现格式问题，欢迎提交 [Issue](https://github.com/zh1-z/SJTU-Master-Midterm-Typst-Template/issues) 反馈。
</details>
...
- ⭐ 给项目[点个 Star](https://github.com/zh1-z/SJTU-Master-Midterm-Typst-Template)
- 🐛 提交 Bug 报告和功能建议
- 🔀 Fork 并改进模板
- 📢 分享给更多需要的同学
